      ...
      <div className="qp-card" style={{ marginTop: 24 }}>
        ...
        {(
          ...
          >
            ...
            <span style={{ textAlign: "right", color: "var(--color-muted)" }}>
              {count}
            </span>
          </div>
        ))}
